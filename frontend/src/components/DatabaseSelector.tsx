...
export const DatabaseSelector: React.FC<DatabaseSelectorProps> = ({
  ...
  return (
    <div className="database-selector bg-gray-50 border border-gray-200 p-4">
      <div className="flex gap-4 items-center">
        ...
        <div className="flex-1">
          ...
          <div className="relative">
            <select
              ...
              className="w-full p-3 text-sm font-medium border border-gray-300 bg-white hover:border-gray-400 focus:outline-none focus:border-blue-500 focus:bg-white transition-all duration-200 appearance-none cursor-pointer"
            >
          ...
          <div className="mt-1 flex items-center gap-1">
            <div className={`w-2 h-2 ${getDialectInfo(sourceDialect)?.color} border border-gray-300`}></div>
        ...
        <div className="flex items-center justify-center mt-6">
          <div className="bg-blue-500 p-2 transition-all duration-200 hover:bg-blue-600">
            <svg
        ...
        <div className="flex-1">
          ...
          <div className="mt-1 flex items-center gap-1">
            <div className={`w-2 h-2 ${getDialectInfo(targetDialect)?.color} border border-gray-300`}></div>
