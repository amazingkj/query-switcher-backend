...
export const SqlConverter: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-light-100 dark:bg-dark-500 transition-colors duration-300">
      <div className="sql-converter max-w-7xl mx-auto p-4 sm:p-6 lg:p-8">
        ...
        {/* Copyright Footer */}
        <div className="mt-12 pt-8 border-t border-light-300 dark:border-dark-200">
          <div className="flex flex-col items-center gap-3">
            <div className="flex items-center gap-4 text-sm text-dark/50 dark:text-light/50">
              <a
                href="https://github.com/amazingkj/query-switcher-backend"
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center gap-1.5 hover:text-primary-500 transition-colors duration-fast"
              >
              ...
              <span className="text-light-300 dark:text-dark-200">|</span>
              <a
                href="https://github.com/amazingkj/query-switcher-backend/issues"
                target="_blank"
                rel="noopener noreferrer"
                className="hover:text-primary-500 transition-colors duration-fast"
              >
                Issue / Feedback
              </a>
            </div>
            <p className="text-center text-xs text-dark/40 dark:text-light/40">
