    ...
    <div className="sql-converter max-w-7xl mx-auto p-8">
      ...
      <div className="mb-8">
        ...
        <div className="mt-4 flex flex-wrap gap-2">
          <button
            ...
            className="px-4 py-1.5 text-xs font-medium text-gray-700 bg-white border border-gray-300 hover:border-gray-400 hover:bg-gray-50 focus:outline-none focus:border-blue-500 focus:bg-gray-50 transition-all duration-200"
          >
          ...
          <button
            ...
            className="px-4 py-1.5 text-xs font-medium text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:bg-indigo-700 transition-all duration-200"
          >
            <svg className="w-3 h-3 inline mr-1.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <button
            ...
            className="px-4 py-1.5 text-xs font-medium text-white bg-slate-600 hover:bg-slate-700 focus:outline-none focus:bg-slate-700 transition-all duration-200"
          >
            <svg className="w-3 h-3 inline mr-1.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <label className="flex items-center px-3 py-1.5 bg-gray-50 border border-gray-200 hover:border-gray-300 transition-all duration-200">
            <input
              ...
              className="w-3 h-3 text-blue-600 border border-gray-300 focus:ring-1 focus:ring-blue-500 mr-2"
            />
      ...
      <div className="mb-6">
        <div className="flex items-center justify-between mb-3">
          <h3 className="text-base font-semibold text-gray-800">SQL 변환기</h3>
          <div className="flex gap-2">
            <button
              onClick={handleConvert}
              disabled={!inputSql.trim() || isLoading}
              className="px-4 py-1.5 text-xs font-medium text-white bg-blue-600 hover:bg-blue-700 disabled:bg-gray-400 disabled:cursor-not-allowed focus:outline-none focus:bg-blue-700 transition-all duration-200"
            >
              <svg className="w-3 h-3 inline mr-1.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <button
              ...
              disabled={!outputSql}
              className="px-4 py-1.5 text-xs font-medium text-white bg-emerald-600 hover:bg-emerald-700 disabled:bg-gray-400 disabled:cursor-not-allowed focus:outline-none focus:bg-emerald-700 transition-all duration-200"
            >
              <svg className="w-3 h-3 inline mr-1.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
